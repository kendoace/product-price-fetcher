        ...
        if (wp_verify_nonce($_POST['ourNonce'], 'fetchProductPrice') AND current_user_can('manage_options')) {
            ...
            if(isset($_FILES["file"]) && $_FILES["file"]["error"] == 0) {
                ...
                if(in_array($filetype, $allowedFileTypes)) {
                    ...
                    $updatedProductIds = array(); // Array to hold updated product IDs
                            ...
                            if ($price != 'unknown') {
                                ...
                                if( $product instanceof WC_Product ) {
                                    ...
                                    if ($regular_price < $new_price) {
                                        ...
                                        $updatedCount++;
                                        $updatedProductIds[] = $product_id; // Add updated product ID to the array
                                    }
                                }
                            }
                        }
                    ...
                    <div class="updated">
                        ...
                        <?php if ($updatedCount > 0) { ?>
                            <p>Updated Product IDs:</p>
                            <ul>
                                <?php foreach ($updatedProductIds as $product_id) { ?>
                                    <li><?php echo $product_id; ?></li>
                                <?php } ?>
                            </ul>
                        <?php } ?>
                    </div>
